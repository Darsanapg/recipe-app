...
const Home= () => {
    ...
    const getData=async()=>{
        try{
          const res=await fetch(`https://api.edamam.com/api/recipes/v2?type=public&q=juice&app_id=4e2ebe50&app_key=%20eb94f7e2af9765f6357b1389e13aa32a`);
    ...
    useEffect(()=>{
      ...
      <Image
       ...
       />
                ...
                <Text style={{ fontWeight: 'bold', color: "black", fontSize:40, alignItems:'center' }}>JUICE RECIPE</Text>
                <TextInput
                type="text"
                name="searchBar"
                id="searchBar"
